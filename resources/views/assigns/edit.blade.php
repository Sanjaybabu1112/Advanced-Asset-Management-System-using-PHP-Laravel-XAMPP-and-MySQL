...
<head>
    <meta charset="UTF-8">
    <title>Edit Assigned Asset</title>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="asset" class="form-control">
                            <option value="{{ $assign->asset }}">{{ $assign->asset }}</option>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="employee" class="form-control">
                            <option value="{{ $assign->employee }}">{{ $assign->employee }}</option>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" name="date" value="{{ $assign->date }}" class="form-control">
                        @error('date')
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="date" name="deadline" value="{{ $assign->deadline }}" class="form-control">
                        @error('deadline')
                        <div class="alert alert-danger mt-1">{{ $message }}</div>
                        @enderror
                    </div>
